-- =========================================================
-- Control One - Datos iniciales (seed)
-- Reemplaza los datos de ejemplo "hardcodeados" en el JS de
-- Organización y Panel Principal por datos reales en la BD,
-- para que dejen de generarse IDs falsos como "t2" o "e1".
-- Ejecutar UNA sola vez, después de los scripts anteriores.
-- =========================================================
...
-- ---------------------------------------------------------
-- TAREAS (asignadas a su categoría por nombre)
-- ---------------------------------------------------------
...
-- ---------------------------------------------------------
-- RECORDATORIOS (independientes, sin tarea/evento asociado)
-- ---------------------------------------------------------
