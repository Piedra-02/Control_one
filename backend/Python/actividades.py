"""
Control One - Backend de Actividades
--------------------------------------
Maneja las operaciones y consultas de datos para la vista de Actividades:
  - Gestión de Correos (consulta, redacción, marcar leído/destacado, eliminación).
  - Gestión de Documentos / Carpetas del Sistema (Downloads, Usuario, Documentos, Videos, Imagenes, Musica, Papelera, Escritorio, Programas x32, Tmp).
  - Gestión de Notas (consulta, creación, edición en vivo, guardado, eliminación).
  - Búsqueda global en tiempo real en correos, documentos y notas.
...
Puede utilizarse como módulo importable o ejecutarse directamente:
    python backend/Python/actividades.py
"""
...
class ActividadesDB:
    """Acceso y lógica de datos para la vista de Actividades."""
    ...
    def _init_mock_data(self):
        ...
        self.correos = [
            {
                ...
                "asunto": "Organízate mejor con la bandeja",
                "cuerpo": "Hola. Descubre las herramientas de organización para clasificar tus correos por categorías y prioridades.",
            ...
            },
            {
                ...
                "email_remitente": "mail-noreply@google.com",
                "destinatario": "usuario@controlone.app",
                "asunto": "Lo mejor de Gmail",
                "cuerpo": "Conoce los atajos de teclado y la búsqueda avanzada para encontrar cualquier mensaje en segundos.",
                "fecha": "2026-08-30T16:20:00",
                "leido": False,
                "destacado": True,
                "categoria": "principal"
            },
            ...
            },
            {
                ...
                "destinatario": "usuario@controlone.app",
                "asunto": "Consejos para usar el correo",
                "cuerpo": "Crea filtros automáticos y etiquetas personalizadas para no perderte ningún mensaje importante.",
                "fecha": "2026-08-28T09:00:00",
                "leido": True,
                "destacado": False,
                "categoria": "principal"
            },
            {
                ...
                "destinatario": "usuario@controlone.app",
                "asunto": "Consejos para usar el correo",
                "cuerpo": "Activa la verificación en dos pasos para proteger la seguridad de tu cuenta.",
                "fecha": "2026-08-27T14:30:00",
                "leido": True,
                "destacado": False,
                "categoria": "principal"
            },
            {
                ...
                "destinatario": "usuario@controlone.app",
                "asunto": "Consejos para usar el correo",
                "cuerpo": "Gestiona tus firmas electrónicas y respuestas automáticas de vacaciones.",
                "fecha": "2026-08-26T18:10:00",
                "leido": True,
                "destacado": False,
                "categoria": "social"
            },
            {
                ...
                "destinatario": "usuario@controlone.app",
                "asunto": "Consejos para usar el correo",
                "cuerpo": "Aprende a programar el envío de correos en la fecha y hora que prefieras.",
        ...
        # 2. CARPETAS Y DOCUMENTOS
        self.carpetas = [
            {
                "id": "f_downloads",
                "nombre": "Downloads",
                "icono": "download",
                "descripcion": "Descargas recientes del navegador",
                "archivos": [
                    {"id": "doc1", "nombre": "Instalador_Control_One.exe", "tamano": "45.2 MB", "tipo": "exe", "fecha": "2026-08-31"},
                    {"id": "doc2", "nombre": "Reporte_Mensual_Agosto.pdf", "tamano": "2.4 MB", "tipo": "pdf", "fecha": "2026-08-30"}
                ]
            },
            {
                "id": "f_usuario",
                "nombre": "Usuario",
                "icono": "user",
                "descripcion": "Archivos del perfil de usuario",
                "archivos": [
                    {"id": "doc3", "nombre": "perfil_avatar.png", "tamano": "1.1 MB", "tipo": "png", "fecha": "2026-08-28"},
                    {"id": "doc4", "nombre": "configuracion_personal.json", "tamano": "14 KB", "tipo": "json", "fecha": "2026-08-29"}
                ]
            },
            {
                "id": "f_documentos",
                "nombre": "Documentos",
                "icono": "file-text",
                "descripcion": "Documentos de texto, hojas de cálculo y proyectos",
                "archivos": [
                    {"id": "doc5", "nombre": "Especificaciones_Control_One.docx", "tamano": "1.8 MB", "tipo": "docx", "fecha": "2026-08-31"},
                    {"id": "doc6", "nombre": "Presupuesto_2026.xlsx", "tamano": "850 KB", "tipo": "xlsx", "fecha": "2026-08-25"},
                    {"id": "doc7", "nombre": "Bitacora_Actividades.txt", "tamano": "42 KB", "tipo": "txt", "fecha": "2026-08-31"}
                ]
            },
            {
                "id": "f_videos",
                "nombre": "Videos",
                "icono": "video",
                "descripcion": "Grabaciones y material multimedia en video",
                "archivos": [
                    {"id": "doc8", "nombre": "Demo_Interactivo.mp4", "tamano": "120.5 MB", "tipo": "mp4", "fecha": "2026-08-29"}
                ]
            },
            {
                "id": "f_imagenes",
                "nombre": "Imagenes",
                "icono": "image",
                "descripcion": "Capturas, fotos e ilustraciones de diseño",
                "archivos": [
                    {"id": "doc9", "nombre": "Mockup_Actividades.png", "tamano": "3.5 MB", "tipo": "png", "fecha": "2026-08-31"},
                    {"id": "doc10", "nombre": "Logo_Vectorial.svg", "tamano": "120 KB", "tipo": "svg", "fecha": "2026-08-20"}
                ]
            },
            {
                "id": "f_musica",
                "nombre": "Musica",
                "icono": "music",
                "descripcion": "Pistas de audio y efectos sonoros",
                "archivos": [
                    {"id": "doc11", "nombre": "Notificacion_Sonido.mp3", "tamano": "340 KB", "tipo": "mp3", "fecha": "2026-08-15"}
                ]
            },
            {
                "id": "f_papelera",
                "nombre": "Papelera",
                "icono": "trash-2",
                "descripcion": "Elementos eliminados temporalmente",
                "archivos": [
                    {"id": "doc12", "nombre": "Borrador_Antiguo.txt", "tamano": "12 KB", "tipo": "txt", "fecha": "2026-08-24"}
                ]
            },
            {
                "id": "f_escritorio",
                "nombre": "Escritorio",
                "icono": "home",
                "descripcion": "Accesos directos y archivos del escritorio",
                "archivos": [
                    {"id": "doc13", "nombre": "Acceso_Control_One.lnk", "tamano": "4 KB", "tipo": "lnk", "fecha": "2026-08-31"}
                ]
            },
            {
                "id": "f_programas",
                "nombre": "Programas x32",
                "icono": "cpu",
                "descripcion": "Software y binarios del sistema de 32 bits",
                "archivos": [
                    {"id": "doc14", "nombre": "ControlOne_Engine.dll", "tamano": "8.4 MB", "tipo": "dll", "fecha": "2026-08-30"}
                ]
            },
            {
                "id": "f_tmp",
                "nombre": "Tmp",
                "icono": "clock",
                "descripcion": "Archivos y cachés temporales de ejecución",
                "archivos": [
                    {"id": "doc15", "nombre": "session_cache.tmp", "tamano": "64 KB", "tipo": "tmp", "fecha": "2026-08-31"}
                ]
            }
        ]
        ...
        self.notas = [
            {
                ...
                "fecha_actualizacion": "2026-08-31T20:00:00"
            }
        ]
    ...
    def crear_correo(self, destinatario, asunto, cuerpo="", remitente="Equipos de Gmail", categoria="principal"):
        if self.usar_mock:
            nuevo = {
                "id": f"c_{len(self.correos) + 1}_{int(datetime.now().timestamp())}",
                "remitente": remitente,
    ...
    def agregar_archivo_carpeta(self, carpeta_id, nombre, tamano="1.2 MB", tipo="txt"):
        if self.usar_mock:
            for f in self.carpetas:
                if f["id"] == carpeta_id or f["nombre"].lower() == carpeta_id.lower():
                    nuevo = {
                        "id": f"doc_{len(f['archivos']) + 1}_{int(datetime.now().timestamp())}",
                        "nombre": nombre.strip(),
                        "tamano": tamano,
                        "tipo": tipo,
    ...
    def guardar_nota(self, nota_id="n1", titulo="Título de la nota", contenido="contenido de la nota"):
        if self.usar_mock:
            ...
            nueva = {
                "id": nota_id or f"n_{len(self.notas) + 1}",
                "titulo": titulo,
                "contenido": contenido,
    ...
    def buscar(self, query):
        """Busca texto en correos, carpetas/documentos y notas."""
        q = query.lower().strip()
        if not q:
        ...
        if self.usar_mock:
            correos_filtrados = [
                c for c in self.correos
                if q in c["remitente"].lower() or q in c["asunto"].lower() or q in c.get("cuerpo", "").lower()
            ]
            ...
            notas_filtradas = [
                ...
                if q in n["titulo"].lower() or q in n.get("contenido", "").lower()
            ]
            ...
            return {
                ...
                "total": len(correos_filtrados) + len(carpetas_filtradas) + len(notas_filtradas)
            }

    def obtener_resumen(self):
        """Retorna todos los datos listos para alimentar la vista Actividades."""
        return {
            "correos": self.obtener_correos(),
            "carpetas": self.obtener_carpetas(),
            "nota_actual": self.obtener_nota("n1"),
            "todas_las_notas": self.obtener_notas(),
            "estadisticas": {
                "total_correos": len(self.correos),
                "correos_no_leidos": len([c for c in self.correos if not c.get("leido", False)]),
                "total_carpetas": len(self.carpetas),
                "total_archivos": sum(len(c.get("archivos", [])) for c in self.carpetas),
...
# =============================================================
# SERVIDOR API HTTP LOCAL PARA ACTIVIDADES
# =============================================================

class ActividadesAPIHandler(BaseHTTPRequestHandler):
    """Manejador HTTP REST para comunicarse con el frontend de Actividades."""
    db = ActividadesDB()
    ...
    def do_POST(self):
        ...
        if parsed.path == "/api/actividades/correos":
            nuevo = self.db.crear_correo(
                destinatario=data.get("destinatario", ""),
                asunto=data.get("asunto", ""),
                cuerpo=data.get("cuerpo", ""),
                remitente=data.get("remitente", "Equipos de Gmail"),
            ...
            nota = self.db.guardar_nota(
                nota_id=data.get("id", "n1"),
                titulo=data.get("titulo", "Título de la nota"),
                contenido=data.get("contenido", "contenido de la nota")
            )
            self._set_headers(200)
...
def iniciar_servidor_actividades(puerto=8002):
    """Inicia el servidor API local para la vista de actividades."""
